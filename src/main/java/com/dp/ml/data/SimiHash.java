...
public class SimiHash {
    ...
    public SimiHash(String tokens) {
        this.tokens = tokens;
        this.intSimHash = this.simHash();
    }

    public SimiHash(String tokens, int hashbits) {
        this.tokens = tokens;
    ...
    public int hammingDistance(SimiHash other) {
     ...
     * @return
     */
    public List<BigInteger> subByDistance(SimiHash simHash, int distance){
    ...
    public static void main(String[] args) {
        ...
        SimiHash hash1 = new SimiHash(s, 64);
        ...
        SimiHash hash2 = new SimiHash(s, 64);
        System.out.println(hash2.intSimHash+ "  " + hash2.intSimHash.bitCount());
        hash1.subByDistance(hash2, 3);
        s = "This is a test string for testing als";
        SimiHash hash3 = new SimiHash(s, 64);
